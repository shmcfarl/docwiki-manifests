# This file is for the UCS C-Series setup for the Grizzly COSI AIO using 'file' as the glance backend (no ceph)
# Working networking setup: build-server = 10.121.13.17, aio-server = 10.121.13.52
# Quantum setup: "Public": 192.168.250.0/24, 192.168.250.10-254 with VLANs 500-600 trunked on eth1
# ---------------------------------------------------------------------------------------------------------------
...
#
#$nexus_credentials = ['10.121.10.39/admin/ranger']
#
